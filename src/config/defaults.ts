...
import { applyAnthropicContextPruningDefaults } from "../providers/builtin/anthropic/context-pruning-defaults.js";
...
export function applyContextPruningDefaults(cfg: OpenClawConfig): OpenClawConfig {
  return applyAnthropicContextPruningDefaults(cfg);
}
