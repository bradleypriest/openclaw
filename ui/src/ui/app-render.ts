      ...
      <main class="content ${isChat ? "content--chat" : ""}">
        ...
        ${state.tab === "skills"
          ? renderSkills({
              ...
              statusFilter: state.skillsFilterStatus,
              sourceFilter: state.skillsFilterSource,
              edits: state.skillEdits,
              messages: state.skillMessages,
              busyKey: state.skillsBusyKey,
              onFilterChange: (next) => (state.skillsFilter = next),
              onStatusFilterChange: (next) => (state.skillsFilterStatus = next),
              onSourceFilterChange: (next) => (state.skillsFilterSource = next),
